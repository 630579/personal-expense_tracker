 ...
 **Data Persistence**:
 ...
 - No additional dependencies are required beyond Python's standard library Usage Running the ApplicationTo start 
- the application, run the following command in your terminal or command prompt:
```sql
 bash :
